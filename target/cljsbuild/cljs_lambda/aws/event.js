...
return camel_snake_kebab.core.__GT_kebab_case_keyword.call(null,G__24390);
}
});
...
return camel_snake_kebab.core.__GT_kebab_case_keyword.call(null,G__24391);
} else {
return G__24391;
}
}
...
cljs_lambda.aws.event.source__GT_key.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__24397){
var vec__24398 = p__24397;
var map__24401 = cljs.core.nth.call(null,vec__24398,(0),null);
...
var delim = cljs.core.get.call(null,map__24401__$1,new cljs.core.Keyword(null,"delim","delim",1621565472),":");
...
/** @this {Function} */
cljs_lambda.aws.event.source__GT_key.cljs$lang$applyTo = (function (seq24395){
var G__24396 = cljs.core.first.call(null,seq24395);
var seq24395__$1 = cljs.core.next.call(null,seq24395);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24396,seq24395__$1);
});
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4324__auto__ = (function cljs_lambda$aws$event$sns_attrs__GT_cljs_$_iter__24406(s__24407){
return (new cljs.core.LazySeq(null,(function (){
var s__24407__$1 = s__24407;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__24407__$1);
if(temp__5457__auto__){
var s__24407__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24407__$2)){
var c__4322__auto__ = cljs.core.chunk_first.call(null,s__24407__$2);
var size__4323__auto__ = cljs.core.count.call(null,c__4322__auto__);
var b__24409 = cljs.core.chunk_buffer.call(null,size__4323__auto__);
if((function (){var i__24408 = (0);
while(true){
if((i__24408 < size__4323__auto__)){
var vec__24410 = cljs.core._nth.call(null,c__4322__auto__,i__24408);
var k = cljs.core.nth.call(null,vec__24410,(0),null);
var attr = cljs.core.nth.call(null,vec__24410,(1),null);
cljs.core.chunk_append.call(null,b__24409,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),camel_snake_kebab.core.__GT_kebab_case_keyword.call(null,attr.call(null,new cljs.core.Keyword(null,"Type","Type",-1483634215))),new cljs.core.Keyword(null,"value","value",305978217),attr.call(null,new cljs.core.Keyword(null,"Value","Value",388561431))], null)], null));

var G__24416 = (i__24408 + (1));
i__24408 = G__24416;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24409),cljs_lambda$aws$event$sns_attrs__GT_cljs_$_iter__24406.call(null,cljs.core.chunk_rest.call(null,s__24407__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24409),null);
}
} else {
var vec__24413 = cljs.core.first.call(null,s__24407__$2);
var k = cljs.core.nth.call(null,vec__24413,(0),null);
var attr = cljs.core.nth.call(null,vec__24413,(1),null);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),camel_snake_kebab.core.__GT_kebab_case_keyword.call(null,attr.call(null,new cljs.core.Keyword(null,"Type","Type",-1483634215))),new cljs.core.Keyword(null,"value","value",305978217),attr.call(null,new cljs.core.Keyword(null,"Value","Value",388561431))], null)], null),cljs_lambda$aws$event$sns_attrs__GT_cljs_$_iter__24406.call(null,cljs.core.rest.call(null,s__24407__$2)));
}
} else {
return null;
}
...
cljs.core._add_method.call(null,cljs_lambda.aws.event.notification__GT_cljs,new cljs.core.Keyword("aws","sns","aws/sns",-873087609),(function (p__24417){
...
var m = map__24418__$1;
var sns = cljs.core.get.call(null,map__24418__$1,new cljs.core.Keyword(null,"Sns","Sns",-1947656007));
...
return cljs.core.update.call(null,G__24420,k,f);
} else {
return G__24420;
}
});
var renames_24421 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"responseElements","responseElements",1111574374),new cljs.core.Keyword(null,"response","response",-1068424192),new cljs.core.Keyword(null,"requestParameters","requestParameters",769634282),new cljs.core.Keyword(null,"request","request",1772954723),new cljs.core.Keyword(null,"userIdentity","userIdentity",1040485874),new cljs.core.Keyword(null,"user","user",1532431356),new cljs.core.Keyword(null,"eTag","eTag",-359698611),new cljs.core.Keyword(null,"etag","etag",-329255476),new cljs.core.Keyword(null,"s3","s3",969970109),new cljs.core.Keyword(null,"s3","s3",969970109),new cljs.core.Keyword(null,"s3SchemaVersion","s3SchemaVersion",-1843087039),new cljs.core.Keyword(null,"s3-schema-version","s3-schema-version",-2141960197)], null);
cljs.core._add_method.call(null,cljs_lambda.aws.event.notification__GT_cljs,new cljs.core.Keyword("aws","s3","aws/s3",970399474),((function (renames_24421){
return (function (m){
return cljs_lambda.aws.event.update_when.call(null,cljs_lambda.aws.event.unfuck.call(null,m,cljs.core.PersistentHashSet.EMPTY,renames_24421),new cljs.core.Keyword(null,"region","region",270415120),cljs.core.keyword);
});})(renames_24421))
);
...
cljs.core._add_method.call(null,cljs_lambda.aws.event.from_aws,new cljs.core.Keyword(null,"notification","notification",-222338233),((function (renames_24429){
...
var records = cljs.core.get.call(null,map__24423__$1,new cljs.core.Keyword(null,"Records","Records",-1562168015));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"records","records",1326822832),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,(function (){var iter__4324__auto__ = ((function (map__24423,map__24423__$1,records,renames_24429){
return (function cljs_lambda$aws$event$iter__24425(s__24426){
return (new cljs.core.LazySeq(null,((function (map__24423,map__24423__$1,records,renames_24429){
return (function (){
var s__24426__$1 = s__24426;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__24426__$1);
if(temp__5457__auto__){
var s__24426__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24426__$2)){
var c__4322__auto__ = cljs.core.chunk_first.call(null,s__24426__$2);
var size__4323__auto__ = cljs.core.count.call(null,c__4322__auto__);
var b__24428 = cljs.core.chunk_buffer.call(null,size__4323__auto__);
if((function (){var i__24427 = (0);
while(true){
if((i__24427 < size__4323__auto__)){
var record = cljs.core._nth.call(null,c__4322__auto__,i__24427);
cljs.core.chunk_append.call(null,b__24428,cljs_lambda.aws.event.notification__GT_cljs.call(null,cljs.core.update.call(null,clojure.set.rename_keys.call(null,record,renames_24429),new cljs.core.Keyword(null,"source","source",-433931539),cljs_lambda.aws.event.source__GT_key)));

var G__24430 = (i__24427 + (1));
i__24427 = G__24430;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24428),cljs_lambda$aws$event$iter__24425.call(null,cljs.core.chunk_rest.call(null,s__24426__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24428),null);
}
} else {
var record = cljs.core.first.call(null,s__24426__$2);
return cljs.core.cons.call(null,cljs_lambda.aws.event.notification__GT_cljs.call(null,cljs.core.update.call(null,clojure.set.rename_keys.call(null,record,renames_24429),new cljs.core.Keyword(null,"source","source",-433931539),cljs_lambda.aws.event.source__GT_key)),cljs_lambda$aws$event$iter__24425.call(null,cljs.core.rest.call(null,s__24426__$2)));
}
} else {
return null;
}
...
});})(map__24423,map__24423__$1,records,renames_24429))
,null,null));
});})(map__24423,map__24423__$1,records,renames_24429))
;
...
var ag_renames_24431 = clojure.set.map_invert.call(null,cljs_lambda.aws.event.ag_renames);
cljs.core._add_method.call(null,cljs_lambda.aws.event.to_aws_STAR_,new cljs.core.Keyword(null,"api-gateway","api-gateway",-1619869738),((function (ag_renames_24431){
return (function (m){
return clojure.set.rename_keys.call(null,m,ag_renames_24431);
});})(ag_renames_24431))
);
/**
 ...
 */
cljs_lambda.aws.event.to_aws = (function cljs_lambda$aws$event$to_aws(p__24432){
...
var event = map__24433__$1;
var type = cljs.core.get.call(null,map__24433__$1,new cljs.core.Keyword("aws.event","type","aws.event/type",-724969211));
